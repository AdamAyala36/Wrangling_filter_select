...
movies %>%
  ...
  drop_na(budget)
```
The code doesn't work because we get rid of the year with our select so the filter does nothing. The drop_na budget could still work since budget is still in the data after the select code.
...
movies_Ques3
```
3 movies are included in this data including, "Harry Potter and the Chamber of Secrets", "Harry Potter and the Prisoner of Azkaban", and Harry Potter and the Sorecerer's Stone". The highest rating Harry Potter movie is, "Harry Potter and the Prisoner of Azkaban". The most voted Harry Potter movie is "Harry Potter and the Sorecerer's Stone".
